 ...
 */
package com.shimizu.ar.core.ar_message.kotlin.common.helpers
...
class ARCoreSessionLifecycleHelper(
  ...
  private fun tryCreateSession(): Session? {
    ...
    if (!CameraPermissionHelper.hasCameraPermission(activity)) {
      permissionArray += Manifest.permission.CAMERA
    }
    if (!LocationPermissionHelper.hasFineLocationPermission(activity)) {
