...
import com.shimizu.ar.core.ar_message.java.common.helpers.SnackbarHelper
import com.shimizu.ar.core.ar_message.java.common.helpers.TapHelper

/** Contains UI elements for Hello AR. */
class ArMessageView(val activity: ArMessageActivity) : DefaultLifecycleObserver {
