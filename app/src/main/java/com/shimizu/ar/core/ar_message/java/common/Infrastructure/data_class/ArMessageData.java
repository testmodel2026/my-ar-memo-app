...
public class ArMessageData implements GeospatialData {
    ...
    public ArMessageData( Double longitude, Double latitude, Double altitude, Float quaternion_x, Float quaternion_y, Float quaternion_z, Float quaternion_w, String message, Integer textColor, Integer backgroundColor) {
