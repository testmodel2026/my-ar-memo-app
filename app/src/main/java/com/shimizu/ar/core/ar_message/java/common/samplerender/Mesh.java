 ...
 */
package com.shimizu.ar.core.ar_message.java.common.samplerender;
...
public class Mesh implements Closeable {
  ...
  public static Mesh createFromInternalStorage(SampleRender render, String internalStorageFileName) throws IOException {
    File internalStorageFile = new File(render.getContext().getFilesDir(), internalStorageFileName);
    try (InputStream inputStream = new FileInputStream(internalStorageFile)) {
      Obj obj = ObjUtils.convertToRenderable(ObjReader.read(inputStream));
